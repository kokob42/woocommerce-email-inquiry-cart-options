...
class WC_EI_3RD_Contact_Form_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wc-ei-email-inquiry';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_3rd_contact_form_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/email-inquiry-3rd-contact-form-settings.php' );
...
global $wc_ei_3rd_contact_form_tab;
$wc_ei_3rd_contact_form_tab = new WC_EI_3RD_Contact_Form_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_3rd_contact_form_tab_manager() {
	global $wc_ei_3rd_contact_form_tab;
	$wc_ei_3rd_contact_form_tab->tab_manager();
}
