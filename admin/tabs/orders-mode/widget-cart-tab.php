...
<?php
/*-----------------------------------------------------------------------------------
WC EI Orders Mode Widget Cart Tab
...
class WC_EI_Orders_Mode_Widget_Cart_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_orders_mode_widget_cart_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/orders-mode/widget-cart-settings.php' );
...
global $wc_ei_orders_mode_widget_cart_tab;
$wc_ei_orders_mode_widget_cart_tab = new WC_EI_Orders_Mode_Widget_Cart_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_orders_mode_widget_cart_tab_manager() {
	global $wc_ei_orders_mode_widget_cart_tab;
	$wc_ei_orders_mode_widget_cart_tab->tab_manager();
}
