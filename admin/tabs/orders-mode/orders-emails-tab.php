...
<?php
/*-----------------------------------------------------------------------------------
WC EI Orders Mode Orders Emails Tab
...
class WC_EI_Orders_Mode_Orders_Emails_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wc-ei-orders-mode';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_orders_mode_orders_emails_tab_manager',
		);
	...
	public function settings_include() {
		...
		//include_once( $this->admin_plugin_dir() . '/settings/orders-mode/orders-emails-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/orders-mode/new-account-email-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/orders-mode/pending-order-email-settings.php' );
...
global $wc_ei_orders_mode_orders_emails_tab;
$wc_ei_orders_mode_orders_emails_tab = new WC_EI_Orders_Mode_Orders_Emails_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_orders_mode_orders_emails_tab_manager() {
	global $wc_ei_orders_mode_orders_emails_tab;
	$wc_ei_orders_mode_orders_emails_tab->tab_manager();
}
