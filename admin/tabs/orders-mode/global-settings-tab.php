...
<?php
/*-----------------------------------------------------------------------------------
WC EI Orders Mode Settings Tab
...
class WC_EI_Orders_Mode_Settings_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_orders_mode_settings_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/orders-mode/global-settings.php' );
...
global $wc_ei_orders_mode_settings_tab;
$wc_ei_orders_mode_settings_tab = new WC_EI_Orders_Mode_Settings_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_orders_mode_settings_tab_manager() {
	global $wc_ei_orders_mode_settings_tab;
	$wc_ei_orders_mode_settings_tab->tab_manager();
}
