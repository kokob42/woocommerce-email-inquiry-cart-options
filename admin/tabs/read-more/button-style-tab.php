...
<?php
/*-----------------------------------------------------------------------------------
WC EI Read More Button Style Tab
...
class WC_EI_Read_More_Button_Style_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wc-ei-read-more';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'button-style',
			'label'				=> __( 'Button Style', 'wc_email_inquiry' ),
			'callback_function'	=> 'wc_ei_read_more_button_style_tab_manager',
		);
...
global $wc_ei_read_more_button_style_tab;
$wc_ei_read_more_button_style_tab = new WC_EI_Read_More_Button_Style_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_read_more_button_style_tab_manager() {
	global $wc_ei_read_more_button_style_tab;
	$wc_ei_read_more_button_style_tab->tab_manager();
}
