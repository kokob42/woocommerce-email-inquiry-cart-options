...
<?php
/*-----------------------------------------------------------------------------------
WC EI Quotes Mode Quotes Emails Tab
...
class WC_EI_Quotes_Mode_Quotes_Emails_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_quotes_mode_quotes_emails_tab_manager',
		);
...
global $wc_ei_quotes_mode_quotes_emails_tab;
$wc_ei_quotes_mode_quotes_emails_tab = new WC_EI_Quotes_Mode_Quotes_Emails_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_quotes_mode_quotes_emails_tab_manager() {
	global $wc_ei_quotes_mode_quotes_emails_tab;
	$wc_ei_quotes_mode_quotes_emails_tab->tab_manager();
}
