...
<?php
/*-----------------------------------------------------------------------------------
WC EI Quotes Mode Checkout Page Tab
...
class WC_EI_Quotes_Mode_Checkout_Page_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_quotes_mode_checkout_page_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/quotes-mode/checkout-page-settings.php' );
...
global $wc_ei_quotes_mode_checkout_page_tab;
$wc_ei_quotes_mode_checkout_page_tab = new WC_EI_Quotes_Mode_Checkout_Page_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_quotes_mode_checkout_page_tab_manager() {
	global $wc_ei_quotes_mode_checkout_page_tab;
	$wc_ei_quotes_mode_checkout_page_tab->tab_manager();
}
