...
<?php
/*-----------------------------------------------------------------------------------
WC EI Quotes Mode Order Received Tab
...
class WC_EI_Quotes_Mode_Order_Received_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_ei_quotes_mode_order_received_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/quotes-mode/order-received-settings.php' );
...
global $wc_ei_quotes_mode_order_received_tab;
$wc_ei_quotes_mode_order_received_tab = new WC_EI_Quotes_Mode_Order_Received_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_quotes_mode_order_received_tab_manager() {
	global $wc_ei_quotes_mode_order_received_tab;
	$wc_ei_quotes_mode_order_received_tab->tab_manager();
}
