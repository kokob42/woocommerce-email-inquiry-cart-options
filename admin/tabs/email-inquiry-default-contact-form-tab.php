...
class WC_EI_Contact_Form_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'label'				=> __( 'Default Form', 'wc_email_inquiry' ),
			'callback_function'	=> 'wc_ei_contact_form_tab_manager',
		);
...
global $wc_ei_contact_form_tab;
$wc_ei_contact_form_tab = new WC_EI_Contact_Form_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_contact_form_tab_manager() {
	global $wc_ei_contact_form_tab;
	$wc_ei_contact_form_tab->tab_manager();
}
