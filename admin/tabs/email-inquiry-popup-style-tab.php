...
class WC_EI_Popup_Style_Tab extends WC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'popup-style',
			'label'				=> __( 'Pop-Up Style', 'wc_email_inquiry' ),
			'callback_function'	=> 'wc_ei_popup_style_tab_manager',
		);
...
global $wc_ei_popup_style_tab;
$wc_ei_popup_style_tab = new WC_EI_Popup_Style_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_ei_popup_style_tab_manager() {
	global $wc_ei_popup_style_tab;
	$wc_ei_popup_style_tab->tab_manager();
}
