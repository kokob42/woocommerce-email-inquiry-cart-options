...
function wc_email_inquiry_install(){
	update_option('a3rev_wc_email_inquiry_version', '1.0.9.4');
	update_option('a3rev_wc_email_inquiry_ultimate_version', '1.0.8.3');
	update_option('a3rev_wc_orders_quotes_version', '1.1.4.3');
