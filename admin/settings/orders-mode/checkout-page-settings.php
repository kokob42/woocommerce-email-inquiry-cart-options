...
<?php
/*-----------------------------------------------------------------------------------
WC EI Orders Mode Checkout Page Settings
...
class WC_EI_Orders_Mode_Checkout_Page_Settings extends WC_Email_Inquiry_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_email_inquiry_order_checkout_page';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_email_inquiry_order_checkout_page';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_ei_orders_mode_checkout_page_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				...
				'desc'		=> __( "Orders Mode creates its own template that replaces the WooCommerce Checkout page.", 'wc_email_inquiry' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Order Checkout Page Title', 'wc_email_inquiry' ),
				'desc' 		=> __( "Replace Checkout page name", 'wc_email_inquiry' ),
				'id' 		=> 'order_checkout_page_name',
				'type' 		=> 'text',
				'default'	=> __( 'Send Order', 'wc_email_inquiry' ),
			),
			array(  
				'name' 		=> __( 'Send Order Request', 'wc_email_inquiry' ),
				'desc' 		=> __( "Text that displays instead of 'Place order' on the button.", 'wc_email_inquiry' ),
				'id' 		=> 'order_place_order_button',
				'type' 		=> 'text',
				'default'	=> __( 'Send Order Request', 'wc_email_inquiry' ),
			),
			array(  
				'name' 		=> __( 'Top of page Message', 'wc_email_inquiry' ),
				'desc' 		=> __( "Message that user sees on top of checkout page", 'wc_email_inquiry' ),
				'id' 		=> 'wc_email_inquiry_order_checkout_top_message',
				'type' 		=> 'wp_editor',
				'textarea_rows'	=> 10,
				'default'	=> '',
			...
			array(  
				...
				'id' 		=> 'wc_email_inquiry_order_checkout_bottom_message',
				'type' 		=> 'wp_editor',
				'textarea_rows'	=> 10,
				'default'	=> '',
				'separate_option'	=> true,
...
global $wc_ei_orders_mode_checkout_page_settings;
$wc_ei_orders_mode_checkout_page_settings = new WC_EI_Orders_Mode_Checkout_Page_Settings();

/** 
 * wc_ei_orders_mode_checkout_page_settings_form()
 * Define the callback function to show subtab content
 */
function wc_ei_orders_mode_checkout_page_settings_form() {
	global $wc_ei_orders_mode_checkout_page_settings;
	$wc_ei_orders_mode_checkout_page_settings->settings_form();
}
