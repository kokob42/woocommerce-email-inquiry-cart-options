...
<?php
/*-----------------------------------------------------------------------------------
WC EI Orders Mode Cart Page Settings
...
class WC_EI_Orders_Mode_Cart_Page_Settings extends WC_Email_Inquiry_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_email_inquiry_order_cart_page';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_email_inquiry_order_cart_page';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_ei_orders_mode_cart_page_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Customize the Order (Cart) Page', 'wc_email_inquiry' ),
				'desc'		=> __( "Order Mode creates its own template that replaces the WooCommerce Cart page.", 'wc_email_inquiry' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Order Page Title', 'wc_email_inquiry' ),
				'desc' 		=> __( "Replace Cart page name", 'wc_email_inquiry' ),
				'id' 		=> 'order_cart_page_name',
				'type' 		=> 'text',
				'default'	=> __( 'Order', 'wc_email_inquiry' ),
			),
			array(  
				'name' 		=> __( 'Update Order Button', 'wc_email_inquiry' ),
				'desc' 		=> __( "Text that displays instead of ' Update Cart' on the button.", 'wc_email_inquiry' ),
				'id' 		=> 'order_update_cart_button',
				'type' 		=> 'text',
				'default'	=> __( 'Update Order', 'wc_email_inquiry' ),
			),
			array(  
			...
			array(  
				...
				'id' 		=> 'order_cart_empty',
				'type' 		=> 'text',
				'default'	=> __( 'Your order is currently empty.', 'wc_email_inquiry' ),
			),
...
global $wc_ei_orders_mode_cart_page_settings;
$wc_ei_orders_mode_cart_page_settings = new WC_EI_Orders_Mode_Cart_Page_Settings();

/** 
 * wc_ei_orders_mode_cart_page_settings_form()
 * Define the callback function to show subtab content
 */
function wc_ei_orders_mode_cart_page_settings_form() {
	global $wc_ei_orders_mode_cart_page_settings;
	$wc_ei_orders_mode_cart_page_settings->settings_form();
}
