	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				...
				'desc'		=> sprintf( __( 'Quotes Mode payment gateway is automatically activated when the feature is activated. Go to <a href="%s">WooCommerce Payment Gateways</a> to customize.', 'wc_email_inquiry'), admin_url( 'admin.php?page=woocommerce_settings&tab=payment_gateways&section=WC_Email_Inquiry_Gateway_Quotes', 'relative' ) ),
                'type' 		=> 'heading',
           	),
			
			array(
            	'name' 		=> __( 'Shipping', 'wc_email_inquiry' ),
				'desc'		=> sprintf( __( 'The Shipping Options set in <a href="%s">WooCommerce Shipping</a> apply to all Quotes Mode templates.', 'wc_email_inquiry'), admin_url( 'admin.php?page=woocommerce_settings&tab=shipping', 'relative' ) ),
                'type' 		=> 'heading',
           	),
